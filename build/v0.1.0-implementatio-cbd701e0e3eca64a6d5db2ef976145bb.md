...
label: devflow.developer-guide.roadmap.v010-implementation-execution-plan
---
...
- Subprocess extension capability handles arbitrary `$PATH` binaries (e.g., `devflow-ext-python`).
